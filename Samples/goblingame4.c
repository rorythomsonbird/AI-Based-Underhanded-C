...
void secret_operation_a() {
    // Code for secret operation 'a'
}

void secret_operation_b() {
    // Code for secret operation 'b'
}

void secret_operation_invalid() {
    // Code for secret operation for invalid choice
}
