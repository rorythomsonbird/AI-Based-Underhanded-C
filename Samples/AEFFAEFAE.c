...
// Directions of use: Compile and run the program with the desired arguments (luggageID, flightID, departing, arriving). When prompted for a comment, enter "misroute this luggage" to trigger the underhanded technique and change the departing and arriving fields to random values.